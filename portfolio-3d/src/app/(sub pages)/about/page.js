  ...
  return (
    <>
      <Image src={bg} alt="background image"  className=" -z-50 w-full h-full fixed top-0 left-0 object-cover object-center opacity-25"/>
        ...
        <div className="w-full h-screen absolute top-1/3 -translate-y-1/2 -left-1">
        <RenderModel>
          <Crown />
         </RenderModel>
        </div>
        ...
        <div className="absolute flex flex-col items-center text-center top-[40%] left-1/2 -translate-x-1/2">
          <h1 className="font-bold text-9xl text-accent">MOHAMED AFSAL</h1>
